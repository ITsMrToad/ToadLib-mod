...
public class ColorCellsWidget extends AbstractWidget {
    ...
    protected void extractWidgetRenderState(@NonNull GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        for (int i = 0; i < this.colorsList.size(); i++) {
            ...
            int borderColor = this.isSelected(color) ? ARGB.color(255, 167, 160, 168) : ARGB.color(255, 128, 120, 120);
        ...
        if (this.getMessage() != CommonComponents.EMPTY) {
            graphics.centeredText(Minecraft.getInstance().font, this.getMessage(), this.getX() * (this.getCellsPerRow() / 2), this.titleY, ToadClientUtils.DEFAULT_TEXT);
        }
    }
