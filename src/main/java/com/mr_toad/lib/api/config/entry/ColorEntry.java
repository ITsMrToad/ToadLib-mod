...
public class ColorEntry extends ConfigEntry<Integer, ColorEntry> {
    ...
    public Integer get() {
        if (this.allowAlpha) {
            ...
            return ARGB.color(255, this.invokeRed(), this.invokeGreen(), this.invokeGreen());
        }
    }
    ...
    public Component getDescription() {
        ...
        return original.copy().append(CommonComponents.NEW_LINE).append(hex);
    }
    ...
    public void validate(int color) throws ConfigException {
        ...
        } else if (this.invokeRed() < 0 || this.invokeRed() > 255) {
    ...
    public int invokeAlpha() {
        ...
        return ARGB.alpha(this.get());
    }

    public int invokeRed() {
        return ARGB.red(this.get());
    }

    public int invokeGreen() {
        return ARGB.green(this.get());
    }

    public int invokeBlue() {
        return ARGB.blue(this.get());
    }
