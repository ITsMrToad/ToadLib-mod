...
public abstract class AbstractCapeableIllager extends AbstractIllager implements ICapeableMob {
    ...
    protected AbstractCapeableIllager(EntityType<? extends AbstractIllager> type, Level world) {
        super(type, world);
    }
