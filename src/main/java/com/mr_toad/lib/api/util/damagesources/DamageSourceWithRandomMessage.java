...
public class DamageSourceWithRandomMessage extends DamageSource {
    ...
    public DamageSourceWithRandomMessage(Holder<@NotNull DamageType> damageTypeHolder, @Nullable Entity entity1, @Nullable Entity entity2, int messagesCount) {
        super(damageTypeHolder, entity1, entity2);
        this.messagesCount = messagesCount;
    }

    public DamageSourceWithRandomMessage(Holder<@NotNull DamageType> damageTypeHolder, Vec3 from, int messagesCount) {
        super(damageTypeHolder, from);
        this.messagesCount = messagesCount;
    }

    public DamageSourceWithRandomMessage(Holder<@NotNull DamageType> damageTypeHolder, @Nullable Entity entity, int messagesCount) {
        super(damageTypeHolder, entity);
        this.messagesCount = messagesCount;
    }

    public DamageSourceWithRandomMessage(Holder<@NotNull DamageType> damageTypeHolder, int messagesCount) {
    ...
    public Component getLocalizedDeathMessage(LivingEntity attacked) {
        ...
        @Nullable LivingEntity livingentity = attacked.getLastHurtByMob();
