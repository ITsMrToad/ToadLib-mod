...
public final class FloatTriplet extends Triplet<Float, Float, Float> {
    ...
    public static FloatTriplet of(final float first, final float second, final float third) {
    ...
    public DoubleTriplet convertToDouble() {
        return DoubleTriplet.of((double) this.first, (double) this.second, (double) this.third);
    }
}
