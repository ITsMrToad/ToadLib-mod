...
public final class DoubleQuadruplet extends Quadruplet<Double, Double, Double, Double> {
    ...
    public static DoubleQuadruplet of(final double first, final double second, final double third, final double fourth) {
        return new DoubleQuadruplet(first, second, third, fourth);
    }
