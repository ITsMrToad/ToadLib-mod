...
public final class DoubleTriplet extends Triplet<Double, Double, Double> {
    ...
    public static DoubleTriplet of(final double first, final double second, final double third) {
    ...
    public FloatTriplet convertToDouble() {
        return FloatTriplet.of(SafeMath.safeDoubleToFloat(this.first), SafeMath.safeDoubleToFloat(this.second), SafeMath.safeDoubleToFloat(this.third));
    }
}
