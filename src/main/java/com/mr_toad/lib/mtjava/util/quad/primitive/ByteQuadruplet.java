...
public final class ByteQuadruplet extends Quadruplet<Byte, Byte, Byte, Byte> {
    ...
    public static ByteQuadruplet of(final byte first, final byte second, final byte third, final byte fourth) {
        return new ByteQuadruplet(first, second, third, fourth);
    }
